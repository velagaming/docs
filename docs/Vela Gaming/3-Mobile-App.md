...
> ##### Example
>
> [http://{PROVIDER_API_SERVICE}/api/user/create?host_id={host_id}&member_id={member_id}¤cy=MYR&password={password}](http://{PROVIDER_API_SERVICE}/api/user/create?host_id={host_id}&member_id={member_id}&currency=MYR&password={password})
...
For change the password for player account, the change password API call should be used.
...
> ##### Example
>
> <http://{PROVIDER_API_SERVICE}/api/user/change-password?host_id={host_id}&member_id={member_id}&password={password}>
...
{
  "method": "get",
  "url": "https://{PROVIDER_API_SERVICE}/api/user/change-password",
  "query": {
    "host_id": "{host_id}",
    "member_id": "{member_id}",
    "password": "{password}"
...
To suspend an active player account, the suspend API call should be used.
...
> ##### Example
>
> <http://{PROVIDER_API_SERVICE}/api/user/suspend?host_id={host_id}&member_id={member_id}>
...
{
  "method": "get",
  "url": "https://{PROVIDER_API_SERVICE}/api/user/suspend",
  "query": {
    "host_id": "{host_id}",
    "member_id": "{member_id}"
  }
...
To activate a suspended player account, the unsuspend API call should be used.
...
> ##### Example
>
> <http://{PROVIDER_API_SERVICE}/api/user/unsuspend?host_id={host_id}&member_id={member_id}>
...
{
  "method": "get",
  "url": "https://{PROVIDER_API_SERVICE}/api/user/unsuspend",
  "query": {
    "host_id": "{host_id}",
    "member_id": "{member_id}"
  }
