...
**(O) is refer to operator need to implement this API.
...
| game_code    | string | Game code refer to [Game List](#game-list) API                                                                      |
...
This API is to cancel the latest Bet call if system error occurred. **Operator needs to implement this API for refund purpose**.
